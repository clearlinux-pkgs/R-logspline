...
Version  : 2.1.22
Release  : 51
URL      : https://cran.r-project.org/src/contrib/logspline_2.1.22.tar.gz
Source0  : https://cran.r-project.org/src/contrib/logspline_2.1.22.tar.gz
...
%setup -q -n logspline
pushd ..
cp -a logspline buildavx2
popd
pushd ..
cp -a logspline buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715629652
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/logspline/libs/logspline.so
/V4/usr/lib64/R/library/logspline/libs/logspline.so
